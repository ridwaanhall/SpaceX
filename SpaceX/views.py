...
class APIRootView(APIView):
    ...
    def get(self, request, format=None):
        return Response({
            ...
            'available_apps': ['stats', 'upcoming', 'launches'],
            'note': 'All endpoints return JSON data. The launches detail endpoint requires a "link" parameter from the launches list.'
