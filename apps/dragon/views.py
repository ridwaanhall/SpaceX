...
class DragonTrackingAPIView(APIView):
    ...
    def get(self, request):
        ...
        try:
            ...
            logger.error(f"Decryption error in DragonTrackingAPIView: {str(e)}")
            return Response({
                'success': False,
            ...
            logger.error(f"Validation error in DragonTrackingAPIView: {str(e)}")
            return Response({
                'success': False,
            ...
            logger.error(f"API error in DragonTrackingAPIView: {str(e)}")
            return Response({
                'success': False,
